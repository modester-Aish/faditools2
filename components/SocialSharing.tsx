  ...
  return (
    <div className={`flex flex-wrap items-center gap-3 ${className}`}>
      ...
      <button
        ...
        className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-600 text-white hover:bg-blue-700 transition-colors duration-200 shadow-md hover:shadow-lg"
      ...
      <button
        ...
        className="flex items-center justify-center w-10 h-10 rounded-full bg-sky-500 text-white hover:bg-sky-600 transition-colors duration-200 shadow-md hover:shadow-lg"
      ...
      <button
        ...
        className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-700 text-white hover:bg-blue-800 transition-colors duration-200 shadow-md hover:shadow-lg"
      ...
      <button
        ...
        className={`flex items-center justify-center w-10 h-10 rounded-full transition-colors duration-200 shadow-md hover:shadow-lg ${
          copied 
