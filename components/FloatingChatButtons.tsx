  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <button
        ...
        className="bg-green-500 text-white p-4 rounded-full shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 flex items-center gap-2 group animate-bounce"
